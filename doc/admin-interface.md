...
a security issue by itself it is not enabled by default. iBut it may be useful for testing 
and debugging. So this feature must be activated in the dataabse by setting the field 'status' 
...
*** sample how to activate the admin interface ***
